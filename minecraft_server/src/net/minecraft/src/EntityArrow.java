...
public class EntityArrow extends Entity {
	...
	public void onUpdate() {
		...
		for(int var8 = 0; var8 < var5.size(); ++var8) {
			...
			if(var9.canBeCollidedWith() && (var9 != this.field_439_ah || this.field_437_aj >= 5)) {
				var10 = 0.3F;
		...
		if(var3 != null) {
			if(var3.entityHit != null) {
				if(var3.entityHit.attackEntityFrom(this.field_439_ah, 4)) {
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if(!this.worldObj.multiplayerWorld) {
			if(this.inGround && this.field_439_ah == var1 && this.arrowShake <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
