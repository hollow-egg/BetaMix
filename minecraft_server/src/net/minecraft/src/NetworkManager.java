...
public class NetworkManager {
	...
	private void sendPacket() {
		try {
			...
			if((var1 || this.field_20175_w-- <= 0) && !this.chunkDataPackets.isEmpty() && (this.chunkDataSendCounter == 0 || System.currentTimeMillis() - ((Packet)this.chunkDataPackets.get(0)).creationTimeMillis >= (long)this.chunkDataSendCounter)) {
				var1 = false;
				var3 = this.sendQueueLock;
				synchronized(var3) {
