...
public class CraftingInventoryPlayerCB extends CraftingInventoryCB {
	...
	public CraftingInventoryPlayerCB(InventoryPlayer var1, boolean var2) {
		...
		this.func_20122_a(new SlotCrafting(this.craftMatrix, this.craftResult, 0, 144, 36));

		int var3;
		int var4;
		for(var3 = 0; var3 < 2; ++var3) {
			for(var4 = 0; var4 < 2; ++var4) {
				this.func_20122_a(new Slot(this.craftMatrix, var4 + var3 * 2, 88 + var4 * 18, 26 + var3 * 18));
			}
		}

		for(var3 = 0; var3 < 4; ++var3) {
			this.func_20122_a(new SlotArmor(this, var1, var1.getSizeInventory() - 1 - var3, 8, 8 + var3 * 18, var3));
		}
