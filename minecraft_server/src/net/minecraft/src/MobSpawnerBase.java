...
public class MobSpawnerBase {
	public static final MobSpawnerBase rainforest = (new MobSpawnerRainforest()).setColor(588342).setBiomeName("Rainforest").func_4080_a(2094168);
	public static final MobSpawnerBase swampland = (new MobSpawnerSwamp()).setColor(522674).setBiomeName("Swampland").func_4080_a(9154376);
	public static final MobSpawnerBase seasonalForest = (new MobSpawnerBase()).setColor(10215459).setBiomeName("Seasonal Forest");
	public static final MobSpawnerBase forest = (new MobSpawnerForest()).setColor(353825).setBiomeName("Forest").func_4080_a(5159473);
	...
	public static final MobSpawnerBase taiga = (new MobSpawnerTaiga()).setColor(3060051).setBiomeName("Taiga").doesNothingForMobSpawnerBase().func_4080_a(8107825);
	...
	public static final MobSpawnerBase iceDesert = (new MobSpawnerDesert()).setColor(16772499).setBiomeName("Ice Desert").doesNothingForMobSpawnerBase().func_4080_a(12899129);
	public static final MobSpawnerBase tundra = (new MobSpawnerBase()).setColor(5762041).setBiomeName("Tundra").doesNothingForMobSpawnerBase().func_4080_a(12899129);
