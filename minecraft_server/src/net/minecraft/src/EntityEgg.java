...
public class EntityEgg extends Entity {
	...
	public void onUpdate() {
		...
		if(this.field_20080_f) {
			int var1 = this.worldObj.getBlockId(this.field_20086_b, this.field_20085_c, this.field_20084_d);
	...
	public void writeEntityToNBT(NBTTagCompound var1) {
		var1.setShort("xTile", (short)this.field_20086_b);
		var1.setShort("yTile", (short)this.field_20085_c);
		var1.setShort("zTile", (short)this.field_20084_d);
		var1.setByte("inTile", (byte)this.field_20082_e);
		var1.setByte("shake", (byte)this.field_20087_a);
		var1.setByte("inGround", (byte)(this.field_20080_f ? 1 : 0));
	}

	public void readEntityFromNBT(NBTTagCompound var1) {
		this.field_20086_b = var1.getShort("xTile");
		this.field_20085_c = var1.getShort("yTile");
		this.field_20084_d = var1.getShort("zTile");
		this.field_20082_e = var1.getByte("inTile") & 255;
		this.field_20087_a = var1.getByte("shake") & 255;
		this.field_20080_f = var1.getByte("inGround") == 1;
	}

	public void onCollideWithPlayer(EntityPlayer var1) {
		if(this.field_20080_f && this.field_20083_aj == var1 && this.field_20087_a <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
