...
public class EntitySnowball extends Entity {
	...
	public void onUpdate() {
		...
		if(!this.worldObj.multiplayerWorld) {
			...
			for(int var8 = 0; var8 < var5.size(); ++var8) {
				...
				if(var9.canBeCollidedWith() && (var9 != this.field_455_ah || this.field_453_aj >= 5)) {
					float var10 = 0.3F;
		...
		if(var3 != null) {
			if(var3.entityHit != null && var3.entityHit.attackEntityFrom(this.field_455_ah, 0)) {
			}
	...
	public void onCollideWithPlayer(EntityPlayer var1) {
		if(this.inGroundSnowball && this.field_455_ah == var1 && this.shakeSnowball <= 0 && var1.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1))) {
