...
public class ChunkProviderLoadOrGenerate implements IChunkProvider {
	...
	public boolean func_21111_c(int var1, int var2) {
		byte var3 = 15;
	...
	public boolean chunkExists(int var1, int var2) {
		if(!this.func_21111_c(var1, var2)) {
			return false;
	...
	public Chunk provideChunk(int var1, int var2) {
		...
		} else if(!this.worldObj.field_9209_x && !this.func_21111_c(var1, var2)) {
	...
	public boolean func_361_a() {
		...
		return this.chunkProvider.func_361_a();
	}
