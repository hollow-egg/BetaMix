...
public class EntitySlime extends EntityLiving implements IMobs {
	...
	public EntitySlime(World var1) {
		...
		this.yOffset = 0.0F;
		this.field_402_ae = this.rand.nextInt(20) + 10;
	...
	public boolean getCanSpawnHere() {
		...
		return (this.slimeSize == 1 || this.worldObj.difficultySetting > 0) && this.rand.nextInt(10) == 0 && var1.func_334_a(987234911L).nextInt(10) == 0 && this.posY < 16.0D;
	}
