...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void replaceBlocksForBiome(int var1, int var2, byte[] var3, MobSpawnerBase[] var4) {
		...
		this.gravelNoise = this.field_702_n.generateNoiseOctaves(this.gravelNoise, (double)(var2 * 16), 109.0134D, (double)(var1 * 16), 16, 1, 16, var6, 1.0D, var6);
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		int var4 = var2 * 16;
		int var5 = var3 * 16;
		MobSpawnerBase var6 = this.worldObj.getWorldChunkManager().func_4067_a(var4 + 16, var5 + 16);
