...
public class ChunkProviderHell implements IChunkProvider {
	...
	public void func_4061_b(int var1, int var2, byte[] var3) {
		...
		this.field_4232_q = this.field_4237_l.generateNoiseOctaves(this.field_4232_q, (double)(var2 * 16), 109.0134D, (double)(var1 * 16), 16, 1, 16, var5, 1.0D, var5);
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		for(var6 = 0; var6 < 8; ++var6) {
			...
			(new WorldGenHellLava(Block.lavaStill.blockID)).generate(this.field_4235_n, this.hellRNG, var7, var8, var9);
		}
		...
		for(var7 = 0; var7 < var6; ++var7) {
			...
			var9 = this.hellRNG.nextInt(120) + 4;
			var10 = var5 + this.hellRNG.nextInt(16) + 8;
			(new WorldGenLightStone1()).generate(this.field_4235_n, this.hellRNG, var8, var9, var10);
		}
		...
		for(var7 = 0; var7 < 10; ++var7) {
			...
			var10 = var5 + this.hellRNG.nextInt(16) + 8;
			(new WorldGenLightStone2()).generate(this.field_4235_n, this.hellRNG, var8, var9, var10);
		}
